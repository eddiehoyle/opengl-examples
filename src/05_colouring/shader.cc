...
StaticShader::StaticShader()
    ...
    const std::string vertex_path = "/Users/eddiehoyle/Code/cpp/opengl-examples/src/05_colouring/shaders/vertex.glsl";
    ...
    const std::string fragment_path = "/Users/eddiehoyle/Code/cpp/opengl-examples/src/05_colouring/shaders/fragment.glsl";
