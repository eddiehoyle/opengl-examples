...
StaticShader::StaticShader()
    ...
    const std::string vertex_path = common::getResource( "shaders/11_diffuse_lighting/vertex.glsl", shader_file_exists );
    ...
    const std::string fragment_path = common::getResource( "shaders/11_diffuse_lighting/fragment.glsl", shader_file_exists );
