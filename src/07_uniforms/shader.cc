...
StaticShader::StaticShader()
    ...
    const std::string vertex_path = common::getResource( "shaders/07_uniforms/vertex.glsl", shader_file_exists );
    ...
    const std::string fragment_path = common::getResource( "shaders/07_uniforms/fragment.glsl", shader_file_exists );
