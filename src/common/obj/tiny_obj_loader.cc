...
//    std::cerr << "posA=" << in_positions.size() << ", comp=" << 3 * i.v_idx + 2 << std::endl;
    ...
    if (i.vt_idx >= 0) {
        ...
        {
            texcoords.push_back( 1 - in_texcoords[index1]);
        }
//        std::cerr << "texA=(" << in_texcoords[index0] << ", " << in_texcoords[index1] << ")" << std::endl;
...
//        std::cerr << "offsetA=" << face.m_offset << std::endl;
...
//                std::cerr << "vertexA : vertex=" << vi.v_idx
//                          << ", texcoord=" << vi.vt_idx
//                          << ", normal=" << vi.vn_idx
//                          << std::endl;
            }

//            std::cerr << __func__ << " : offset=" << face.m_offset
//                    << ", indices=" << face.m_numIndices
//                      << std::endl;
