...
void ShaderProgram::loadLight( const Light& light ) {
    ...
    std::cerr << __func__ << " : light=" << glm::to_string( light.getPosition() ) << std::endl;
...
void StaticShader::init() {
    ...
    const std::string vertex_path = common::getResource( "shaders/21_terrain_height_map/vertex.glsl", shader_file_exists );
    ...
    const std::string fragment_path = common::getResource( "shaders/21_terrain_height_map/fragment.glsl",
                                                           shader_file_exists );
...
void TerrainShader::init() {
    ...
    // Read in vertex shader
    const std::string vertex_path = common::getResource( "shaders/21_terrain_height_map/terrainVertex.glsl",
                                                         shader_file_exists );
    const std::string vertex_source = common::read_file( vertex_path );
    m_vertexShaderID = compile( vertex_source, GL_VERTEX_SHADER );
    ...
    // Read in fragment shader
    const std::string fragment_path = common::getResource( "shaders/21_terrain_height_map/terrainFragment.glsl",
                                                           shader_file_exists );
    const std::string fragment_source = common::read_file( fragment_path );
    m_fragmentShaderID = compile( fragment_source, GL_FRAGMENT_SHADER );
    assert( shader_file_exists );
